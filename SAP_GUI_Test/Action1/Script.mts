...
'Create Inquiry
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Initial").SAPGuiEdit("Inquiry Type").Set "IN" @@ hightlight id_;_30_;_script infofile_;_ZIP::ssf2.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Initial").SAPGuiEdit("Sales Organization").Set "ORAS" @@ hightlight id_;_34_;_script infofile_;_ZIP::ssf2.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Initial").SAPGuiEdit("Distribution Channel").Set "OR" @@ hightlight id_;_35_;_script infofile_;_ZIP::ssf2.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Initial").SAPGuiEdit("Division").Set "OD" @@ hightlight id_;_31_;_script infofile_;_ZIP::ssf2.xml_;_
...
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Overview").SAPGuiEdit("PO Number").Set "100034" @@ hightlight id_;_42_;_script infofile_;_ZIP::ssf3.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Overview").SAPGuiEdit("PO date").Set "10/12/2017" @@ hightlight id_;_36_;_script infofile_;_ZIP::ssf3.xml_;_
...
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Overview").SAPGuiEdit("Valid from").Set "10/12/2017" @@ hightlight id_;_48_;_script infofile_;_ZIP::ssf3.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Inquiry: Overview").SAPGuiEdit("Valid to").Set "10/12/2018" @@ hightlight id_;_49_;_script infofile_;_ZIP::ssf3.xml_;_
...
SAPGuiSession("Session").SAPGuiWindow("Create Quotation: Overview").SAPGuiEdit("PO Number").Set "100034" @@ hightlight id_;_43_;_script infofile_;_ZIP::ssf10.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Quotation: Overview").SAPGuiEdit("PO date").Set "10/12/2017" @@ hightlight id_;_37_;_script infofile_;_ZIP::ssf10.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Quotation: Overview").SAPGuiEdit("Valid from").Set "10/12/2017" @@ hightlight id_;_49_;_script infofile_;_ZIP::ssf10.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Quotation: Overview").SAPGuiEdit("Valid to").Set "10/12/2018" @@ hightlight id_;_50_;_script infofile_;_ZIP::ssf10.xml_;_
...
SAPGuiSession("Session").SAPGuiWindow("Create Standard Order:").SAPGuiEdit("PO Number").Set "100036" @@ hightlight id_;_43_;_script infofile_;_ZIP::ssf22.xml_;_
SAPGuiSession("Session").SAPGuiWindow("Create Standard Order:").SAPGuiEdit("PO date").Set "10/12/2017" @@ hightlight id_;_37_;_script infofile_;_ZIP::ssf22.xml_;_
